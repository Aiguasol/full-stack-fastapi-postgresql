...
class User(MigrationBase):
    ...
    companies = relationship("CompanyUserAssociation", back_populates="user")

    role_id = Column(Integer, ForeignKey("role.id"), nullable=False)
    role = relationship("Role", back_populates="users")

    shipment_updates = relationship("ShipmentUpdate", back_populates="issued_by_user")
    shipments_owned = relationship("Shipment", back_populates="owner")
...
def schema_upgrades(session: Session):
    ...
    # create tables individually otherwise
